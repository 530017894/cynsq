 ...
 *
 */
class Essearch extends Controller
{
    //根据埋点id聚合
    public static function search()
    {
        ...
        //$end_time = date("Y-m-d H:00:00", strtotime("+1 hour"));
        $params            = [];
        ...
        if (isset($response["aggregations"]["pre"]["buckets"]) && count($response["aggregations"]["pre"]["buckets"]) > 0) {
            $insert_day = date("Ymd", strtotime("-1 hour"));
            $insert_hour = date("H", strtotime("-1 hour"));
    ...
    //地域统计
    public static function areaacount()
    {
        $start_time = date("Y-m-d H:00:00", strtotime("-1 hour"));
        $end_time = date("Y-m-d H:00:00", time());
        //$end_time = date("Y-m-d H:00:00", strtotime("+1 hour"));
    ...
    //设备统计
    public static function deviceacount()
    {
        $start_time = date("Y-m-d H:00:00", strtotime("-1 hour"));
        $end_time = date("Y-m-d H:00:00", time());
        //$end_time = date("Y-m-d H:00:00", strtotime("+1 hour"));
